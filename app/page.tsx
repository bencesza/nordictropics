      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-20 text-center">
            <Link href="/products" className="border-2 border-gray-900 text-gray-900 px-10 py-3 rounded-full text-lg font-semibold hover:bg-gray-900 hover:text-white transition-colors">
