...
const team = [
  ...
  },
  {
    ...
    location: 'Kenya',
    image: '/rock-v2.jpg',
    bio: 'Rock is a water governance specialist with expertise in land, water, sanitation, and soil quality management. He ensures that our farming practices are built on optimized irrigation systems, leveraging state-of-the-art technologies such as drip irrigation, while integrating renewable energy solutions to power production infrastructure. This end-to-end approach guarantees environmentally sustainable crop production designed to protect natural resources and support future generations.',
  },
];
