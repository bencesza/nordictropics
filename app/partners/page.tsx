...
const partnerCategories = [
  {
    ...
    description:
      'We supply major supermarket chains and independent retailers across the Nordic region with premium, shelf-ready tropical fruits.',
    icon: '🛒',
  },
  {
    title: 'Wholesale & Distribution',
    description:
      'Partnering with regional wholesalers and fruit specialists to ensure wide availability of our Kenyan produce.',
    icon: '🚛',
  },
  {
    title: 'Foodservice & HoReCa',
    description:
      'Premium ingredients for restaurants, hotels, and catering. Consistent grade and custom specifications available.',
    icon: '🍽️',
  },
];
